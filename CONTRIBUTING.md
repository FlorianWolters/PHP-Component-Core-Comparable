...
Contributions to **FlorianWolters\Component\Core\Comparable** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\Comparable**:

    md Comparable && cd Comparable
    git clone git://github.com/FlorianWolters/PHP-Component-Core-Comparable.git
